...
spark-submit \
--master yarn \
--name "[Squad FI] Motor de ingestao - Carga Diaria Secao" \
--executor-memory 20G \
--executor-cores 4 \
--num-executors 9 \
...
/projetos/plfinanceiro/bin/CoreFI/Main.py -c rwzd_ac01 ext_td_ac01_dsdpm190_tsecao19 data_referencia secao

impala-shell -k -i ${impala_shell_ip} -q "INVALIDATE METADATA rwzd_ac01.ext_td_ac01_dsdpm190_tsecao19;"