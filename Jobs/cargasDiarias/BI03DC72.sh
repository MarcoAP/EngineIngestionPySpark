...
spark-submit \
--master yarn \
--name "[Squad FI] Motor de ingestao Diario - Hist Produto - BI03DC72.sh" \
--executor-memory 20G \
--executor-cores 4 \
--num-executors 9 \
...
/projetos/plfinanceiro/bin/CoreFI/Main.py -exec rwzd_ac01 td_ac01_dsdpm010_tprodu01 2 rwzd_ac01_hist ext_td_ac01_dsdpm010_tprodu01

impala-shell -k -i $impala_shell_ip -B -q "INVALIDATE METADATA rwzd_ac01_hist.ext_td_ac01_dsdpm010_tprodu01;"