...
spark-submit \
--master yarn \
--name "[Squad FI] Motor de ingestao Diario - Hist Grupo - BI03DC74.sh" \
--executor-memory 20G \
--executor-cores 4 \
--num-executors 9 \
...
/projetos/plfinanceiro/bin/CoreFI/Main.py -exec rwzd_ac01 td_ac01_dsdpm160_tgrupo16 2 rwzd_ac01_hist ext_td_ac01_dsdpm160_tgrupo16

impala-shell -k -i $impala_shell_ip -B -q "INVALIDATE METADATA rwzd_ac01_hist.ext_td_ac01_dsdpm160_tgrupo16;"