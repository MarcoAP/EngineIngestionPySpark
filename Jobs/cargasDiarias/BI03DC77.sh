...
spark-submit \
--master yarn \
--name "[Squad FI] Motor de ingestao Diario - Hist Local - BI03DC77.sh" \
--executor-memory 20G \
--executor-cores 4 \
--num-executors 9 \
...
/projetos/plfinanceiro/bin/CoreFI/Main.py -exec rwzd_ac01 td_ac01_dsdpm070_tlocal07 2 rwzd_ac01_hist ext_td_ac01_dsdpm070_tlocal07

impala-shell -k -i $impala_shell_ip -B -q "INVALIDATE METADATA rwzd_ac01_hist.ext_td_ac01_dsdpm070_tlocal07;"