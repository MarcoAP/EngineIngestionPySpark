...
spark-submit \
--master yarn \
--name "[Squad FI ] TSZD_FINACEIRO.DEPARTAMENTO" \
--executor-memory 20G \
--executor-cores 4 \
--num-executors 9 \
...
--queue "SquadFI" \
/projetos/plfinanceiro/bin/Datalake/Trusted/TrustedMain.py -i rwzd_ac01_hist ext_td_ac01_dsdpm180_tdepat18 $dt

impala-shell -k -i ${impala_shell_ip} -q "INVALIDATE METADATA tszd_financeiro.departamento;"