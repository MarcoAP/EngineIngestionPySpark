...
spark-submit \
--master yarn \
--name "[Squad FI ] TSZD_FINACEIRO.SECAO" \
--executor-memory 20G \
--executor-cores 4 \
--num-executors 9 \
...
--queue "SquadFI" \
/projetos/plfinanceiro/bin/Datalake/Trusted/TrustedMain.py -i rwzd_ac01_hist ext_td_ac01_dsdpm190_tsecao19 $dt

impala-shell -k -i ${impala_shell_ip} -q "INVALIDATE METADATA tszd_financeiro.secao;"