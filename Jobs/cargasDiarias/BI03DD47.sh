...
spark-submit \
--master yarn \
--name "[Squad FI] Motor de ingestão - RWZD_AC01.DIVISAO_SUPERIOR" \
--executor-memory 20G \
--executor-cores 4 \
--num-executors 9 \
...
--queue "SquadFI" \
--jars /projetos/plfinanceiro/bin/Libs/commons-csv-1.2.jar,/projetos/plfinanceiro/bin/Libs/spark-csv_2.11-1.5.0.jar /projetos/plfinanceiro/bin/CoreFI/Main.py -h rwzd_ac01 ext_td_ac01_divisao_superior data_referencia

impala-shell -k -i ${impala_shell_ip} -q "INVALIDATE METADATA rwzd_ac01.ext_td_ac01_divisao_superior;"