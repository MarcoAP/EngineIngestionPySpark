...
spark-submit \
--master yarn \
--name "[Squad FI] Motor de ingestao RWZD_AC01_HIST.DIVISAO_SUPERIOR" \
--executor-memory 20G \
--executor-cores 4 \
--num-executors 9 \
...
--queue "SquadFI" \
--jars /projetos/plfinanceiro/bin/Libs/commons-csv-1.2.jar,/projetos/plfinanceiro/bin/Libs/spark-csv_2.11-1.5.0.jar /projetos/plfinanceiro/bin//CoreFI/Main.py -exec rwzd_ac01 ext_td_ac01_divisao_superior 2 rwzd_ac01_hist ext_td_ac01_divisao_superior

impala-shell -k -i ${impala_shell_ip} -q "INVALIDATE METADATA rwzd_ac01_hist.ext_td_ac01_divisao_superior;"