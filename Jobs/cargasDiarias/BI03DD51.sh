...
spark-submit \
--master yarn \
--name "[Squad FI] TSZD_FINACEIRO.DIVISAO_SUPERIOR" \
--executor-memory 20G \
--executor-cores 4 \
--num-executors 9 \
...
--queue "SquadFI" \
/projetos/plfinanceiro/bin/Datalake/Trusted/TrustedMain.py -i rwzd_ac01_hist ext_td_ac01_divisao_superior $dt

impala-shell -k -i ${impala_shell_ip} -q "INVALIDATE METADATA tszd_financeiro.divisao_superior;"