...
--queue "SquadFI" \
--jars commons-csv-1.2.jar,spark-csv_2.11-1.5.0.jar CoreFI/Main.py -h rwzd_user_input_hist ext_status_loja_descricoes dt_processamento
...
--conf "spark.authenticate.secret=none" \
--queue "SquadFI" \
--jars commons-csv-1.2.jar,spark-csv_2.11-1.5.0.jar CoreFI/Main.py -h rwzd_user_input_hist ext_status_loja_hist dt_processamento