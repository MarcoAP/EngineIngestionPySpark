...
CREATE TABLE IF NOT EXISTS rfzd_financeiro.det_solic_senha (   
...
STORED AS PARQUET 
LOCATION '/gpa/refinedzone/rfzd_financeiro/det_solic_senha' 
TBLPROPERTIES ('parquet.compression'='SNAPPY','COMMENT' = 'Tabela de senhas solicitadas, origem ac34')