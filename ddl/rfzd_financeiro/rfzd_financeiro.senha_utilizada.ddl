...
CREATE TABLE IF NOT EXISTS rfzd_financeiro.senha_utilizada 
(
...
,cod_usu_alter_preco STRING COMMENT "Codigo usuario alterou o preco (alter_preco_plu_loja)"
,nom_usu_alter_preco STRING COMMENT "Nome usuario alterou o preco"
...
,val_vig DOUBLE COMMENT "Valor Vigente (pos altera?o de preco por RD)"
...
,ind_valid_senha_fami BOOLEAN COMMENT "Codigo de Validacao de senha para Familia (false=Senha inv?ida para Familia / true=Senha v?ida para familia)" 
...
,ind_senha_local BOOLEAN COMMENT "Indicador de senha localizada (true = localizada e false = não localizada)"
,num_cupom INT COMMENT "Numero do cupom"
,num_term INT COMMENT "Numero do terminal"
...
STORED AS PARQUET 
TBLPROPERTIES ("parquet.compression"="SNAPPY", "COMMENT" = "Tabela com visao geral de impacto das senhas utilizadas")
;