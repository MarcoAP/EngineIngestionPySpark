...
CREATE EXTERNAL TABLE IF NOT EXISTS siac_store_hist.ext_descbonusfidelidade (
  codloja STRING,
  numterminal STRING,
  ...
  qtdevenda STRING,
  valorprecooriginal STRING,
  valorprecopromoprod STRING,
...
STORED AS PARQUET
LOCATION "/gpa/rawzone/stg/siac_store_hist/ext_descbonusfidelidade"
